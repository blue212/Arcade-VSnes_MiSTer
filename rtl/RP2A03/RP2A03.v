...
// Combinatorics
assign Reset = ~nRES;
assign M2_out = nRES ? M2 : 1'b1;//1'hZ;
assign ADDR_BUS[15:0] = nRES ? ADR[15:0] : 16'hFFFF;//16'hZZZZ;
assign OUT[2:0]  = nRES ? OUTR[2:0] : 3'b111;//3'hZ;
assign nIN[1:0]  = nRES ? { nR4017, nR4016 } : 2'b11;//2'hZ;
...
always @(posedge Clk) begin
       ...
       if ( W4011 | DMSTEP | Reset ) DMC_OUT[5:0]   <= ( Reset ? 6'h00 : W4011 ? DB[6:1] : DMC_OUT1[5:0] );//try this?  
